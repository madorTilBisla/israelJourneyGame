...
window.addEventListener("load", function() {
    ...
    if (window.location.href.includes("index")) {
    ...
    } else if (window.location.href.includes("kiryatShmona") ||
            window.location.href.includes("haifa") || 
            window.location.href.includes("hadera") || 
            window.location.href.includes("telaviv") || 
            window.location.href.includes("mitzpeRamon") || 
            window.location.href.includes("eilat") || 
            window.location.href.includes("jerusalem") || 
            window.location.href.includes("beerSheva") ||
            window.location.href.includes("ashdod")) {
        ...
        loadElements();
    } else if (window.location.href.includes("endGam")) {
